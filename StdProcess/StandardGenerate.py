...
MEDIA_PIPE_ROOT = Path(__file__).resolve().parent.parent  # 获取 config 文件所在目录的上一级目录，也就是仓库根目录
# from Config.paths import MEDIA_PIPE_ROOT  # 导入 MEDIA_PIPE_ROOT 的路径配置
